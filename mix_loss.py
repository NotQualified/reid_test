...
from reid.loss import TripletLoss, MixedLoss
from reid.trainers import Trainer
from reid.evaluators import Evaluator
from reid.utils.data import transforms as T
from reid.utils.data.preprocessor import Preprocessor
from reid.utils.data.sampler import RandomIdentitySampler, RandomTripPairSampler
...
def main(args):
    ...
    # Criterion
    criterion = MixedLoss(class_weight = args.class_weight, \
